...
export function generateNamePair(id: string): {
	...
	const GLOBAL_SEED = 'game5'; // Change this to a unique seed for each game
	...
	const lastNameIndex = Math.floor(rng() * lastNames.length);
...
'Hernandez', 'Lopez', 'Gonzalez', 'Wilson', 'Anderson', 'Thomas', 'Taylor', 'Moore', 'Jackson', 'Thumble',
...
'Kode', 'Lag', 'Modem', 'Nuke', 'Override', 'Probe', 'Quantum', 'Reboot', 'Scanner', 'Toggle',
'Update', 'Vector', 'Wave', 'Xenon', 'Yield', 'Zap', 'Amp', 'Bandwidth', 'Core', 'Drone',
'Echo', 'Frame', 'Gigahertz', 'Hub', 'Interface', 'Durotan', 'Keyframe', 'Latency', 'Morph', 'Node',
'Ops', 'Packet', 'Qbit', 'Render', 'Sensor', 'Trace', 'User', 'Vertex', 'Wattage', 'Xcode',
'Yottabit', 'Zeta'
]
